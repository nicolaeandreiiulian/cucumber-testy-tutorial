...
public class ChangePasswordTest extends TestBase {
    ...
    public void changePasswordWithInvalidCurrentPassword() {
        ...
        page.changePassword("eu2@fast.com", "newPass", "newPass");
        assertThat(page.getStatusMessage(), is("Your preview password is incorrect!"));

    }

    @Test
    public void changePasswordWithInvalidPreviewPassword() {
        openPage();

        page.changePassword("currentPass", "newPass", "repeatPass");
        assertThat(page.getStatusMessage(), is("Your preview password is incorrect!"));
    }
